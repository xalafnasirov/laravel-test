    ...
    <div class="wcu-area">
        <div class="as-container2 position-relative bg-title">
            ...
            <div class="anime-img-1 shape-mockup jump d-none d-lg-block" data-bottom="0%" data-right="0"><img
                    src="assets/img/wcu/wcu_shape.png" alt="img"></div>
                        ...
                        <div class="info-media-wrap">
                            ...
                            <div class="info-media">
                                ...
                                <div class="media-body">
                                    ...
                                    <p class="info-media_text">Energistically conceptualize adaptive convergence
                                        without multifunctional materials. Assertively impact real-time.</p>
                                </div>
                            </div>
        ...
        <div class="container space-top pt-xl-0 pb-xl-0">
            <form action="mail.php" method="POST" class="booking-form ajax-contact">
                <!-- bg animated image -->
                <div class="anime-img-2 bg-anime-scratch shape-mockup d-none d-md-block" data-top="0%"
                    data-left="0"><img src="assets/img/wcu/wcu_filter_bg_1.png" alt="img"></div>
                <div class="anime-img-3 bg-anime-scratch shape-mockup d-none d-lg-block" data-top="37%"
                    data-right="0"><img src="assets/img/wcu/wcu_filter_bg_2.png" alt="img"></div>
                    ...
                    <div class="col-xl-7">
                        <div class="row gy-20">
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <select name="classes" class="form-select style2">
                                        <option value="" disabled="disabled" selected="selected" hidden>Car
                                            Brand</option>
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <select name="classes" class="form-select style2">
                                        <option value="" disabled="disabled" selected="selected" hidden>Zip
                                            Code</option>
                            ...
                            <div class="row as-carousel product-slider g-0" data-slide-show="4"
                                ...
                                <div class="col-xl-3 col-lg-4 col-sm-6">
                                    <div class="as-product">
                                        ...
                                        <div class="product-content">
                                            <p class="meta">Vehicle Parts</p>
                                            <h4 class="product-title h5"><a href="shop-details.html">BMW Brake
                                                    Liver</a></h4>
                                            <span class="price">$125.00</span>
                                            <a class="as-btn style3" href="checkout.html"><i
                                                    class="fa-regular fa-cart-shopping me-2"></i> ADD TO CART</a>
                                ...
                                <div class="col-xl-3 col-lg-4 col-sm-6">
                                    <div class="as-product">
                                        ...
                                        <div class="actions">
                                            ...
                                            <a class="icon-btn popup-content" href="#QuickView"><i
                                                    class="fa-regular fa-eye"></i></a>
                                            <span class="icon-btn rating-btn"><i
                ...
                <div class="col-xxl-6 col-xl-8 col-lg-8 text-center">
                    <div class="title-area mb-0">
                        ...
                        <div class="btn-group justify-content-center">
                            ...
                            <a class="as-btn style3" href="tel:+16312020088"><i
                                    class="fa-solid fa-phone me-1"></i> +163 1202 0088</a>
                        </div>
                    </div>
                </div>
            </div>
...
==============================-->
    <div class="container">
        <div class="service-slider row as-carousel g-0" data-slide-show="3" data-lg-slide-show="3"
            ...
            <div class="col-lg-4 col-md-6">
                <div class="service-card">
                    <h3 class="service-card_title"><a href="service-details.html">Car Repair</a></h3>
            ...
            <div class="row as-carousel team-slider" data-slide-show="4" data-lg-slide-show="3"
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="team-card">
                        ...
                        <div class="as-social">
                            <a class="icon-bg-custom" target="_blank" href="https://facebook.com/"><i
                                    class="fa-brands fa-facebook-f"></i></a>
                            <a class="icon-bg-custom" target="_blank" href="https://youtube.com/"><i
                                    class="fa-brands fa-youtube"></i></a>
                            <a class="icon-bg-custom" target="_blank" href="https://twitter.com/"><i
                                    class="fa-brands fa-twitter"></i></a>
                            <a class="icon-bg-custom" target="_blank" href="https://dribbble.com/"><i
...
==============================-->
    <section class="portfolio-area space-top" data-overlay="title" data-opacity="9"
        ...
        <div class="portfolio-anime-img shape-mockup d-none d-xl-block" data-top="0%" data-left="0"><img
                class="svg-img" src="assets/img/portfolio/portfolio_bg_shape.svg" alt="img"></div>
        <!-- bg animated image /-->
            ...
            <div class="row portfolio-slider-1 as-carousel" id="portfolio-slider1" data-slide-show="5"
                ...
                <div class="col-lg-3">
                    <div class="portfolio-box">
                        <img class="portfolio-box_img" src="assets/img/portfolio/portfolio_1-v2.png"
                            alt="img">
                        <div class="portfolio-box_details">
                            <h3 class="portfolio-box_title h4"><a href="project-details.html">Dent Repair Glass</a>
                            </h3>
                ...
                <div class="col-lg-3">
                    <div class="portfolio-box">
                        <img class="portfolio-box_img" src="assets/img/portfolio/portfolio_2-v2.png"
                            alt="img">
                        <div class="portfolio-box_details">
                            <h3 class="portfolio-box_title h4"><a href="project-details.html">Dent Repair Glass</a>
                            </h3>
                ...
                <div class="col-lg-3">
                    <div class="portfolio-box">
                        <img class="portfolio-box_img" src="assets/img/portfolio/portfolio_3-v2.png"
                            alt="img">
                        <div class="portfolio-box_details">
                            <h3 class="portfolio-box_title h4"><a href="project-details.html">Dent Repair Glass</a>
                            </h3>
                ...
                <div class="col-lg-3">
                    <div class="portfolio-box">
                        <img class="portfolio-box_img" src="assets/img/portfolio/portfolio_4-v2.png"
                            alt="img">
                        <div class="portfolio-box_details">
                            <h3 class="portfolio-box_title h4"><a href="project-details.html">Dent Repair Glass</a>
                            </h3>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-6 order-lg-2 align-self-center">
                    <div class="testi-thumb text-center" data-bg-src="assets/img/testimonial/testi_thumb_bg.png">
                        ...
                        <div class="anime-img-1 jump shape-mockup d-none d-md-block" data-bottom="-10%"
                            data-right="0"><img src="assets/img/testimonial/testi_thumb_1.png" alt="img">
                        </div>

                        <div class="action jump3 testi-indicator" data-asnavfor="#testimonial-indicator">
                            <a class="testi-indicator-btn testi-indicator-6 active" href="#"><img
                                    src="assets/img/testimonial/testi_indicate-1.png" alt="img"></a>
                            <a class="testi-indicator-btn testi-indicator-5" href="#"><img
                                    src="assets/img/testimonial/testi_indicate-2.png" alt="img"></a>
                            <a class="testi-indicator-btn testi-indicator-4" href="#"><img
                                    src="assets/img/testimonial/testi_indicate-3.png" alt="img"></a>
                            <a class="testi-indicator-btn testi-indicator-3" href="#"><img
                                    src="assets/img/testimonial/testi_indicate-4.png" alt="img"></a>
                            <a class="testi-indicator-btn testi-indicator-2" href="#"><img
                                    src="assets/img/testimonial/testi_indicate-5.png" alt="img"></a>
                            <a class="testi-indicator-btn testi-indicator-1" href="#"><img
                                    src="assets/img/testimonial/testi_indicate-6.png" alt="img"></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 order-lg-1">
                    ...
                    <div class="testimonial-slider as-carousel" data-slide-show="1" data-lg-slide-show="1"
                        data-md-slide-show="1" data-sm-slide-show="1" data-xs-slide-show="1" data-fade="true"
                        id="testimonial-indicator">
                        <div class="testi-box">
                            <p class="testi_content">Quickly predominate user-centric ideas rather compelling
                                technology. Compellingly orchestrate intuitive infomediarie before adaptive poten
                                tialities. Competently recaptiualize highly efficient intellectual capital rather than
                                highly efficient partnerships. Continually evisculate.</p>
                        ...
                        <div class="testi-box">
                            <p class="testi_content">Compellingly deploy premier web services via granular total
                                linkage. Professionally strategize resource maximizing portals for cross-unit systems.
                                Monotonectally Quality vectors with virtual supply chains. Quickly predominate
                                user-centric ideas rather compelling technology.</p>
                            <div class="testi-box_profile">
                                <div class="icon">
                                    <img src="assets/img/icon/quote.svg" alt="img">
                                </div>
                        ...
                        <div class="testi-box">
                            <p class="testi_content">Compellingly orchestrate user-centric ideas rather compelling
                                technology. Quickly predominate intuitive infomediarie before adaptive poten tialities.
                                Competently recaptiualize highly efficient intellectual capital rather than highly
                                efficient partnerships. Continually evisculate.</p>
                            <div class="testi-box_profile">
                                <div class="icon">
                                    <img src="assets/img/icon/quote.svg" alt="img">
                                </div>
                        ...
                        <div class="testi-box">
                            <p class="testi_content">
                                Quickly predominate user-centric ideas rather compelling technology. Compellingly
                                orchestrate intuitive infomediarie before adaptive poten tialities. Competently
                                recaptiualize highly efficient intellectual capital rather than highly efficient
                                partnerships. Continually evisculate.</p>
                            <div class="testi-box_profile">
                                <div class="icon">
                                    <img src="assets/img/icon/quote.svg" alt="img">
                                </div>
...
==============================-->
    <section class="blog-area space-bottom" id="blog-sec" data-bg-src="assets/img/bg/blog_bg_1.png">
        <div class="container">
            ...
            <div class="blog-slider row as-carousel" data-slide-show="3" data-lg-slide-show="2"
                data-md-slide-show="2" data-sm-slide-show="1" data-xs-slide-show="1" data-arrows="true"
                data-xl-arrows="true" data-ml-arrows="true">
                <div class="col-md-6 col-xl-4">
                    <div class="blog-card">
                        ...
                        <div class="blog-content">
                            ...
                            <h3 class="blog-title box-title"><a href="blog-details.html">Distributed throughout the
                                    all
                                    over country.</a>
                            </h3>
                            <p class="blog-text">Progressive conceptualize 2.0 potential Through parallel customer
                                service.</p>
                ...
                <div class="col-md-6 col-xl-4">
                    <div class="blog-card">
                        ...
                        <div class="blog-content">
                            ...
                            <p class="blog-text">Dealer Accumsan tincidunt. Vestibul ante ipsum primis in faucibus
                                orci luctus.</p>
                            <a href="blog-details.html" class="line-btn">Read More</a>
                        </div>
                    </div>
                ...
                <div class="col-md-6 col-xl-4">
                    <div class="blog-card">
                        ...
                        <div class="blog-content">
                            ...
                            <h3 class="blog-title box-title"><a href="blog-details.html">Sixteen tips for fix and
                                    repairs
                                    for starting problem</a>
                            </h3>
                            <p class="blog-text">Pretium ut lacinia in, elementum id enim. Proin eget tortor risus.
                                Proin risus.</p>
                            <a href="blog-details.html" class="line-btn">Read More</a>
                        </div>
                    </div>
    ...
    <div class="client-sec1 space-bottom">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="title-area text-center">
                        <h2 class="client-title h4 mb-0"><span class="double-line"></span> WE HAVE TRUSTED MORE THEN
                            <span class="text-theme">20K+</span>GLOBAL CLIENTS</h2>
                    </div>
                </div>
            </div>
