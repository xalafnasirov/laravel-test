  ...
  */
  ...
  /*---------- 01. On Load Function ----------*/
    ...
    $(document).ready(function () {
        $('#brand-list').hide(); // Initially hide the brand list

        $('#toggle-brands').click(function () {
            $('#brand-list').slideToggle(); // Toggle the visibility with a sliding effect
        });

        $('#category-list').hide(); // Initially hide the brand list

        $('#toggle-category').click(function () {
            $('#category-list').slideToggle(); // Toggle the visibility with a sliding effect
        });

        $('#part-list').hide(); // Initially hide the brand list

        $('#toggle-part').click(function () {
            $('#part-list').slideToggle(); // Toggle the visibility with a sliding effect
        });
    });
