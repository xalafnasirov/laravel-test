                                    ...
                                    <table id="example" class="table table-striped table-bordered dataTable"
                                        ...
                                        <thead>
                                            <tr role="row">
                                                ...
                                                <th><label>Tarix
                                                        <input wire:model.live="search_date" type="date">
                                                </th>
                                                ...
                                                <th><label>Müştəri adı:<input type="search"
                                                            wire:model.live='search_customer'
                                                            class="form-control form-control-sm" placeholder="" 
                                                            aria-controls="example" list="customer_name" ></label>
                                                            <datalist id="customer_name">
                                                                @foreach ($all_order as $single)
                                                                    <option value="{{$single->customer}}"></option>
                                                                @endforeach
                                                            </datalist>
                                                </th>
                                        ...
                                        <thead>
                                            <tr role="row link-light">
                                                ...
                                                <th class="sorting_desc" tabindex="0" aria-controls="example"
                                                    ...
                                                    aria-sort="descending" style="width: 35.375px;">Marka</th>
                                                <th class="sorting" tabindex="0" aria-controls="example"
                                                    rowspan="1" colspan="1"
                                                    aria-label="Start date: activate to sort column ascending"
                                                    style="width: 10px;">İli</th>

                                                <th class="sorting" tabindex="0" aria-controls="example"
                                                    rowspan="1" colspan="1"
                                                    aria-label="Salary: activate to sort column ascending"
                                                    style="width: 64.375px;">Yanacaq tipi</th>
                                                <th class="sorting" tabindex="0" aria-controls="example"
                                                    rowspan="1" colspan="1"
                                                    aria-label="Salary: activate to sort column ascending"
                                                    style="width: 64.375px;">Sil</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            @foreach ($all_order as $single)
                                                <tr role="row link-light">
                                                    ...
                                                    <td>{{ $single->phone }}</td>
                                                    <td class="sorting_1">{{ $single->brand }}</td>
                                                    <td>{{ $single->year ? $single->year : '-' }}</td>
                                                    <td>{{ $single->fuel_type ? $single->fuel_type : '-' }}</td>
                                                    <td><button wire:click="remove({{ $single->id }})">Sil</button>
                                                    </td>
                                                </tr>
                                            @endforeach
                                        </tbody>
