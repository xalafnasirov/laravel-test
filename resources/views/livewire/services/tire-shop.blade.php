            ...
            <div class="col-xl-9 col-lg-8">
                <div class="as-sort-bar">
                    <div class="row g-sm-0 gy-20 justify-content-between align-items-center">
                        <div class="col-md d-flex justify-content-between align-items-center">
                            {{-- <p class="woocommerce-result-count mb-0">{{ $filtered_product_count }} məhsul</p> --}}
                ...
                <div class="tab-content" id="nav-tabContent">
                    ...
                    <style>
                        ...
                        .new-items {
                            margin-bottom: 20px;
                            /* Ensure there’s space for the search input */
                        }
                    </style>
                    ...
                    <div class="tab-pane fade active show" id="tab-list" role="tabpanel"
                        ...
                        @isset($filtered_product)
                            <div class="row gy-25">
                                        ...
                                        <div class="as-product">
                                            ...
                                            <div class="product-content">
                                                ...
                                                <button wire:click='add_to_cart({{ $single->id }})'
                                                    class="as-btn style3"><i class="fa-regular fa-cart-shopping me-2"></i>
                                                    SİFARİŞ VER</button>
                                            </div>
                                ...
                                @endforeach --}}
                                @foreach ($filtered_product as $item)
                                    <div class="col-xl-4 col-sm-6">
                                        <div wire:click='open_product{{$item->id}}' class="as-product">

                                            <div class="product-head">
                                                <span class='tire-tag'>{{ $item->brand }}</span>
                                                <span class='tire-tag'>{{ $item->year }}</span>
                                                <span class='tire-tag'>{{ $item->season }}</span>
                                            </div>

                                            <div class="actions">
                                                {{-- @auth
                                                    <a class="icon-btn"
                                                        href="{{ route('dashboard.go', ['panel' => 'orders']) }}"><i
                                                            class="fa-regular fa-heart"></i></a>
                                                @else
                                                    <a class="icon-btn" href="{{ route('login') }}"><i
                                                            class="fa-regular fa-heart"></i></a>
                                                @endauth --}}

                                            </div>
                                            <a href="{{ route('services.shop_single', ['id' => $item->id]) }}">
                                                <div class="product-img">

                                                    @isset($product_image[$item->id])
                                                        <img src="{{ asset('/storage/' . $product_image[$item->id]->image) }}"
                                                            alt="product image" loading='lazy'>
                                                    @endisset
                                            ...
                                            <div class="product-content">
                                                ...
                                                <h4 class="product-title h5"><a
                                                        href="{{ route('services.shop_single', ['id' => $item->id]) }}">{{ $item->type }}
                                                        | {{ $item->speed_index }} | {{ $item->load_index }}</a></h4>
                                                <span class="price">{{ $item->price }} AZN</span>
                                                <button wire:click='add_to_cart({{ $item->id }})' onclick="event.stopPropagation();"
                                                    class="as-btn style3"><i class="fa-regular fa-cart-shopping me-2"></i>
                                                    SİFARİŞ VER</button>
                                            </div>
                ...
                <aside class="sidebar-area">
                    ...
                    @isset($part_name)
                        ...
                        <div class="widget widget_categories">
                            ...
                            <h3 id="toggle-part" class="widget_title">Hissə adları &#160; <i class="fal fa-angle-down"></i>
                            </h3>
